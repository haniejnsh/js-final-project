...
export function  htmlOnboardingPg2() {
    // console.log("jkdhfkjehfrrrrrrrrrr");
        document.querySelector("#app").innerHTML= `<div class="w-full flex flex-col justify-end text-white gap-6 pl-5 pb-20" style="background-image:linear-gradient(to bottom, rgba(0,0,0,0.0), rgba(0, 0, 0, 0.5) ), url('../picture/WallpaperDog-20534610\ 1.png');">
        <div class="text-2xl font-bold">
          <span>Welcome to</span>
          <span class="text-3xl text-yellow-200">👋</span>
        </div>
        <div class="text-5xl font-bold">Shoea</div>
        <div class="text-xs font-bold w-5/6">The best sneakers & shoes e-commerse app of the century for your fashion needs!</div>
    </div>`;
