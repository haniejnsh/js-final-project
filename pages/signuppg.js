...
export function  htmlSignUpPg() {
    ...
    <div ><img class=" w-12 h-12 object-cover go-back cursor-pointer " src="./picture/prev icon.png" alt=""></div>

    <div class="h-1/4 flex"><img class="m-auto" src="./picture/logo.png" alt=""></div>

    <div class="text-center text-2xl font-bold mt-4">Create Your Account</div>

    <div class="flex grow">
      <form action="" class="w-full mt-12 flex flex-col gap-3">
        ...
        <div class="flex flex-col justify-end grow pb-6">
          <input type="button" id="form-btn-signup" value="Create Account" class="bg-gray-500 w-5/6 rounded-2xl text-sm py-1 mx-auto  text-white">
        </div>
